...
//
//         //when
//         FundReservationDto fundReservationDto = new FundReservationDto(1L, "test fund reservation", "test content", 0, true, 1L);
...
//
//         //when
//         existingFundReservation.updateFundReservation(new FundReservationDto(
//             1L, "새로운 투자예약", existingFundReservation.getContent(), existingFundReservation.getYield(), true, 1L
//         ));
//         em.flush();
//         em.clear();
//
